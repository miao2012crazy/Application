 ...
 */
public class SkinSampleAdapter extends BaseQuickAdapter<SkinKeepingBean,BaseViewHolder> {


    public SkinSampleAdapter(int skup_view1_item, List<SkinKeepingBean> skupKeepingBeen) {
        super(skup_view1_item, skupKeepingBeen);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, SkinKeepingBean skupKeepingsBean) {
     ...
     */
    private int getDrawable(SkinKeepingBean skupKeepingsBean) {
    ...
    private void initLv(SkinKeepingBean skupKeepingsBean, BaseViewHolder baseViewHolder) {
